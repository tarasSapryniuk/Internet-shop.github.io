                            ...
                            <div class="header_extra ml-auto">
                                <div class="shopping_cart">
                                    <a href="/cart">
                                        ...
                                        <div>Cart <span>(<?= Cart::countItems(); ?>)</span></div>
                                    </a>
                                </div>
                                <div class="search">
                ...
                <ul class="page_menu_nav menu_mm">
                    <li class="page_menu_item has-children menu_mm">
                        ...
                        <ul class="page_menu_selection menu_mm">
                            ...
                            <li class="page_menu_item menu_mm"><a href="/cart/checkout">Checkout<i class="fa fa-angle-down"></i></a></li>
                            <li class="page_menu_item menu_mm"><a href="/contacts/">Contact<i class="fa fa-angle-down"></i></a></li>
                        </ul>
                    </li>
                    <li class="page_menu_item has-children menu_mm">
                    ...
                    <li class="page_menu_item menu_mm"><a href="/contacts/">Contact<i class="fa fa-angle-down"></i></a></li>
                    <?php if (User::isGuest()): ?>                                        
                        <li class="page_menu_item menu_mm"><a href="/user/login/">Log in</a></li>
                        <?php else: ?>
                        <li class="page_menu_item has-children menu_mm">
                            <a href="/cabinet/">Account<i class="fa fa-angle-down"></i></a>
                            <ul class="page_menu_selection menu_mm">
