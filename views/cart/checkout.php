            ...
            <div class="row">
                            ...
                            <form action="#" id="checkout_form" class="checkout_form" method="post">
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <input type="text" id="userName" class="checkout_input" value="<?php echo $userName; ?>" required="required">
                                    </div>
                                ...
                                <div>
                                    <!-- Company -->
                                    <label for="userComment">Company</label>
                                    <input type="text" id="userComment" class="checkout_input">
                                </div>
                                <div>
                                    <!-- Country -->
                                ...
                                <div>
                                    ...
                                    <input type="phone" id="userPhone" class="checkout_input" value="<?php echo $userPhone; ?>" required="required">
                                </div>
                                <div>
                                    <!-- Email -->
                                ...
                                <div class="checkout_extra">
                                    <div>
                                        ...
                                        <label for="checkbox_terms"><img src="/template/images/check.png" alt=""></label>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox_account"><img src="/template/images/check.png" alt=""></label>
                                    ...
                                    <div>
                                        ...
                                        <label for="checkbox_newsletter"><img src="/template/images/check.png" alt=""></label>
                ...
                <div class="col-lg-6">
                    <div class="order checkout_section">
                        ...
                        <input class="button order_button" type="submit" name="submit" class="btn btn-default" value="Place Order">
                         </form>
                    </div>
                </div>
